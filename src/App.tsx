...
function App() {
  ...
  const prayers: Prayer[] = [
    ...
    },
    {
      ...
      description: `อะระหัง สัมมา สัมพุทโธ ภะคะวา พุทธังภะคะวันตัง อภิวาเทมิ (กราบ)
  ...
  const extendedPrayers: Prayer[] = [
    {
      ...
      description: `สัพพัง อะปะราธัง ขะมะถะ เม ภันเต อุกาสะ ทวารัตเยนะ กะตัง
        สัพพัง อะปะราธัง ขะมะถะ เม ภันเต อุกาสะ ขะมามิ ภันเตฯ

        หากข้าพระพุทธเจ้า ได้เคยประมาทพลาดพลั้งล่วงเกิน ต่อพระรัตนตรัย
        อันมีพระพุทธเจ้าทุกๆพระองค์ พระปัจเจกพุทธเจ้าทุกๆพระองค์ พระธรรม และพระอริยสงฆ์ทั้งหลาย 
    ...
    },
    {
      ...
      description: `อิทัง ปุญญะ พะลัง
        ...
        ผลบุญใดที่ข้าพเจ้าได้บำเพ็ญ มาแล้ว ณโอกาสนี้ 
        ...
        ขอให้เทพเจ้าทั้งหลาย และพญายมราช จงอนุโมทนาส่วนกุศลนี้ 
        และขอจงเป็นสักขีพยาน ในการบำเพ็ญกุศลของข้าพเจ้าในครั้งนี้ด้วยเถิด

        และข้าพเจ้าขออุทิศส่วนกุศลนี้ ให้แก่ท่านทั้งหลาย ที่ล่วงลับไปแล้ว 
        ที่เสวยความสุขอยู่ก็ดี เสวยความทุกข์อยู่ก็ดี 
        เป็นญาติก็ดี มิใช่ญาติก็ดี 
        ขอให้ท่านทั้งหลายจงอนุโมทนาส่วนกุศลนี้ พึงได้รับประโยชน์ และความสุข 
        เช่นเดียวกับข้าพเจ้า จะพึงได้รับ ณกาลบัดเดี๋ยวนี้เถิด

        ผลและบุญใดที่ข้าพเจ้าได้บำเพ็ญแล้ว ณโอกาสนี้ 
